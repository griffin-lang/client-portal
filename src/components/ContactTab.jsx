...
export default function ContactTab({ contact }) {
  return (
    <div style={{ padding: '8px 20px 28px' }}>
      ...
      <div style={{ background: '#fff', borderRadius: 20, padding: 22, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10, border: '1px solid rgba(15,23,42,0.07)', marginBottom: 16, marginTop: 16 }}>
        ...
        <div style={{ fontSize: 14, color: 'rgba(15,23,42,0.55)', textAlign: 'center' }}>{contact.role}</div>
        <div style={{ fontSize: 12.5, color: 'rgba(15,23,42,0.4)', marginTop: 2 }}>{contact.since}</div>
      </div>
      ...
      <div style={{ background: '#fff', borderRadius: 18, border: '1px solid rgba(15,23,42,0.07)', padding: '14px 16px', display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 12.5, color: 'rgba(15,23,42,0.5)' }}>Account Director</div>
        </div>
      </div>

      <div style={sectionLabel}>Plan &amp; Notes</div>
      <div style={{ background: '#fff', borderRadius: 18, border: '1px solid rgba(15,23,42,0.07)', padding: 16 }}>
        ...
        <div style={{ fontSize: 14, lineHeight: 1.5, color: 'rgba(15,23,42,0.65)' }}>{contact.notes}</div>
      </div>
    </div>
  );
}
