    ...
    <div style={{ position: 'absolute', inset: 0, background: '#FAFAFA', zIndex: 200, display: 'flex', flexDirection: 'column' }}>
      <div style={{ paddingTop: 24, flex: 1, overflowY: 'auto' }}>
        <div style={{ padding: '8px 20px 24px' }}>
          ...
          <div style={{ fontSize: 14.5, color: 'rgb(var(--ink-rgb) / 0.5)', marginBottom: 20 }}>{appt.type}</div>
          ...
          <div style={{ background: '#fff', borderRadius: 18, border: '1px solid rgb(var(--ink-rgb) / 0.07)', padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 16 }}>
      ...
      <div style={{ padding: '14px 20px 20px', display: 'flex', gap: 10, background: 'rgba(250,250,250,0.92)', backdropFilter: 'blur(16px)', borderTop: '1px solid rgb(var(--ink-rgb) / 0.07)' }}>
